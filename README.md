# MESH-API v0.7.3.5 Beta — Initial Full MeshCore Support Is Here!

> ## 🎉 v0.7.3.5 Beta — Initial Full MeshCore Support
>
...
>
> Also new in v0.7.3.5: a built-in **MCP (Model Context Protocol) server** that turns MESH-API into an agentic backend for AI tools, and a **firmware/software update system** that detects your device and notifies you when a newer Meshtastic, MeshCore, or MESH-API version is available. See the dedicated sections below.
